...
## Skrub's vision
The goal of skrub is to accelerate building and deploying machine-learning models on pandas and polars dataframes (later, SQL databases). Its philosophy and API match that of scikit-learn.


## In this presentation
We will introduce the current way of doing things, then the alternative with skrub.
