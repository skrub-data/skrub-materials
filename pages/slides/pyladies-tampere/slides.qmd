...
Use any env tool you're comfortable with! If you have never used
virtual environments before, use `venv`.   
...
- [#2064](https://github.com/skrub-data/skrub/issues/2064) - Sort long API reference sections 😴 🐈 🏃 
