...
date: 2025-10-01
canonical-url: "https://skrub-data.org/skrub-materials/pydata-2025/"
...
format: 
    revealjs:
        ...
        css: style.css
        footer: "https://skrub-data.org/skrub-materials/pydata-2025/"
incremental: true
freeze: auto
---

## `whoami`
- I am a research engineer at Inria in the P16 team, and I am the lead developer of skrub ![](images/skrub.svg){width=150}
...
<a href="dataop_report/index.html" target="_blank">report</a>
...
## Tuningwith `DataOps` is not limited to estimators
::: {.panel-tabset}
### Pandas
```{python}
import pandas as pd
